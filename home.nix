{
  ...
  old-packages = with pkgs.old; [
    ...
    qt4 gperftools tcl tk gnumake tclreadline readline boost
    cmake    gfortran11 bison flex bzip2 mpi
...
in {
  ...
  programs = {
    ...
    git = {
      ...
      userEmail = "jiaqiwang969@gmail.com"; # FIXME: set your git email
      userName = "jiaqiwang969"; #FIXME: set your git username
      extraConfig = {
